...
The templates used to create the files live under ``renatos_macro_templates`` and
...
TEMPLATES: Dict[str, str] = {
    "API Onboarding": os.path.join(ROOT_DIR, "renatos_macro_templates", "api ob"),
    "Simple Disconnection": os.path.join(
        ROOT_DIR, "renatos_macro_templates", "simple disconnection"
    ),
...
def create_api_onboarding(
    ...
    with open(f'{dirs["case"]}/dataloader.txt', 'w') as f:
        f.write(','.join(hotel_ids))
